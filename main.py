from src import csv_excel_readers, external_api, generators, masks, processing, re_collections, utils, widget
...
print(re_collections.process_bank_search(excel_transactions_check[:10], "карты"))
