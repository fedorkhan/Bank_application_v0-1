...
def test_get_date1(time_example1: str, date_example1: str) -> None:
    assert get_date(time_example1) == date_example1


def test_get_date2(time_example2: str, date_example2: str) -> None:
...
def test_mask_account_card(card_account_info: str, masked_card_account: str) -> None:
